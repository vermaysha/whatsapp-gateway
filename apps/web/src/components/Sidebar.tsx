import { INavLink, Navigation } from "./Navigation"
...
function Sidebar() {
  return (
    <aside className="h-screen">
      ...
      <ul className="menu w-80 h-screen bg-base-100 lg:border-r">
        {<Navigation navLinks={mainNav} />}
        <li className="menu-title">API</li>
        {<Navigation navLinks={apiNav} />}
      </ul>
    </aside>
  )
}
